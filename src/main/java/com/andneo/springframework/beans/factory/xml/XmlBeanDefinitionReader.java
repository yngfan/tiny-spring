...
//        ResourceLoader resourceLoader = getResourceLoader();
    ...
    private void doLoadBeanDefinitions(InputStream inputStream) {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (StrUtil.isNotEmpty(initMethod)) beanDefinition.setInitMethodName(initMethod);
            if (StrUtil.isNotEmpty(destroyMethodName)) beanDefinition.setDestroyMethodName(destroyMethodName);
